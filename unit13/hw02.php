...
<head>
    ...
    <title>乙班26號陳維基13-2</title>
    <link rel="stylesheet" href="./002/css/main.css">
    <link rel="stylesheet" href="./002/css/content.css">
    <link rel="stylesheet" href="https://fonts.googleapis.com/css2?family=Material+Symbols+Outlined:opsz,wght,FILL,GRAD@20..48,100..700,0..1,-50..200" />
    <script src="./002/js/main.js"></script>
    <script src="./002/js/data.js"></script>
    <script src="./002/js/interface.js"></script>
</head>

<body>
    <div id="header">
        <a class="content">乙班26號陳維基13-2</a>
